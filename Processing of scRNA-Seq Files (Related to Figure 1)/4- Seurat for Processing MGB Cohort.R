...
pdf("SeqWell_WT_Mutant_Tumors_Clusters_With_Labels.pdf", height= 6, width = 7)
DimPlot(Tumors.combined, reduction = "umap", label=TRUE)
dev.off()

pdf("SeqWell_WT_Mutant_Tumors_UMAP_Patient_ID.pdf", height= 6, width = 9)
...
saveRDS(Tumors.combined, file="SeqWell_Brain_Tumors.rds")
